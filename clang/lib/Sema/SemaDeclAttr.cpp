...
TypeVisibilityAttr *
Sema::mergeTypeVisibilityAttr(Decl *D, SourceRange Range,
...
static void handleCallConvAttr(Sema &S, Decl *D, const ParsedAttr &AL) {
  ...
  case ParsedAttr::AT_CDecl:
    D->addAttr(::new (S.Context) CDeclAttr(AL.getRange(), S.Context,
                                           AL.getAttributeSpellingListIndex()));
    return;
  ...
  case ParsedAttr::AT_MSABI:
    D->addAttr(::new (S.Context) MSABIAttr(AL.getRange(), S.Context,
                                           AL.getAttributeSpellingListIndex()));
    return;
...
void Sema::AddParameterABIAttr(SourceRange range, Decl *D, ParameterABI abi,
  ...
  case ParameterABI::SwiftContext:
    ...
    D->addAttr(::new (Context) SwiftContextAttr(range, Context, spellingIndex));
    return;
...
static void handleFortifyStdLib(Sema &S, Decl *D, const ParsedAttr &AL) {
  ...
  D->addAttr(::new (S.getASTContext())
                 FortifyStdLibAttr(AL.getLoc(), S.getASTContext(), BOSType,
